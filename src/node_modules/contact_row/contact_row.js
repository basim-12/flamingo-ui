...
async function contact_row(opts = {}, protocol) {
  ...
  async function ondata(data) {
    const { avatar, name, message, time, unread, online, lightining, p2p_enabled } = data[0] || {}
      ...
      <div class="contact-left">
        ...
        <div class="contact-info">
          <div class="contact-name-row">
            ...
            <div class="chat-status-badge ${p2p_enabled === true ? 'enabled' : 'disabled'}">${p2p_enabled === true ? 'Chat Enabled' : 'Chat Disabled'}</div>
          </div>
