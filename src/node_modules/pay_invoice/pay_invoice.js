...
async function pay_invoice(opts = {}, callbacks = {}) {
  ...
  button_container.addEventListener('click', async () => {
    ...
    current_invoice = inv
    status_el.textContent = '⏳ Decoding invoice...'
