...
async function input_field (opts = {}) {
  ...
  // Public getter so parent components can read the typed value
  // without needing to pierce the closed shadow DOM
