...
async function qr_code(opts = {}) {
  ...
  // Public API: update the QR for a new address from outside this component
  el.setAddress = function (address) {
    render_qr_code(address)
  }
  ...
  async function render_qr_code(address) {
    qr_container.innerHTML = '' // clear previous
    if (!address) return
