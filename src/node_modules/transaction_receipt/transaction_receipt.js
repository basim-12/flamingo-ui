      ...
      if (r.convert) {
        ...
        if (btcBtn && usdBtn && valueEl) {
          ...
          usdBtn.addEventListener('click', async function () {
            ...
            // Extract numeric BTC from the original value (e.g. "0.02456000 BTC" -> 0.02456)
            const btcMatch = originalValue.match(/([\d.]+)/)
            if (btcMatch) {
